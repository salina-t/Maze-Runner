...
public class MediaFile  
{
     ...
     * writes a string to the file, followed by the delimiter character.  The method will
     * write a new line character only if the newLine parameter is true.
     * 
     * @param s The string text to be written.
     * @param delim the character that will follow String s
     * @param newLine determine whether or not the NEXT string will be written
     *        on a new line or not.
     */
    public static void writeString(String s, String delim, boolean newLine) {
        if (out == null) {
            try {
